...
// HasDepartmentDiagnose applies the HasEdge predicate on the "department_diagnose" edge.
func HasDepartmentDiagnose() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DepartmentDiagnoseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, DepartmentDiagnoseTable, DepartmentDiagnoseColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasDepartmentDiagnoseWith applies the HasEdge predicate on the "department_diagnose" edge with a given conditions (other predicates).
func HasDepartmentDiagnoseWith(preds ...predicate.Diagnose) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DepartmentDiagnoseInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, DepartmentDiagnoseTable, DepartmentDiagnoseColumn),
		)
